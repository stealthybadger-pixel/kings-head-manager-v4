...
export type ViewType = 'dashboard' | 'pantry' | 'catalog' | 'kitchen' | 'service' | 'stock' | 'suppliers' | 'settings';
...
const App: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'pantry', label: 'Pantry (Ingredients)', icon: Database },
    { id: 'catalog', label: 'Supplier Catalog (Wholesale)', icon: BookOpen },
    { id: 'kitchen', label: 'Kitchen (Prep Recipes)', icon: ChefHat },
    { id: 'service', label: 'Service (Menu Dishes)', icon: Utensils },
    { id: 'stock', label: 'Stock Manager (Inventory)', icon: Boxes },
    { id: 'suppliers', label: 'Suppliers', icon: Truck },
    { id: 'settings', label: 'Help & Glossary (Guide)', icon: HelpCircle },
  ] as const;
